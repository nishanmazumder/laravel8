...
<div class="banner-bootom-w3-agileits">
    <div class="container">
        ...
        <div class="col-md-4 single-right-left ">
            <div class="grid images_3_of_2">
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="{{asset('/uploads')}}{{'/'.$product->product_img}}">
                            <div class="thumb-image"> <img src="{{asset('/uploads')}}{{'/'.$product->product_img}}" data-imagezoom="true"
        ...
        <div class="col-md-8 single-right-left simpleCart_shelfItem">
            ...
            <p><span class="item_price">Tk. {{$product->product_price}}</span> <del>- $900</del></p>
            <div class="rating1" style="margin-bottom: 20px">
            ...
            <div class="occasional color-quality-right">
                <h5>Color :</h5>
                <select id="country1" onchange="change_country(this.value)" class="frm-field required sect">
                    <option value="null">5 Qty</option>
                    <option value="null">6 Qty</option>
